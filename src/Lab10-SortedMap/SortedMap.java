...
public interface SortedMap  //--ADT SortedMap
{
   /**
   ...
   */
   Object put(Comparable key, Object value);
   ...
   */
   ...
   /**
      restituisce un array ordinato contenente le chiavi della mappa.
      La relazione d'ordine sia definita dalla chiave.
      @return array ordinato contenente tutte le chiavi della mappa
   */
